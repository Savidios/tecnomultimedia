...
//https://www.youtube.com/watch?v=2W8PxMGArsQ
PImage fondo;
PImage fondo2;
PImage fondo3;
PImage fondo4;
...
PImage fondo9;
PImage fondo10;
PImage fondoCreditos; // Nuevo fondo para la pantalla de créditos
PFont fuente;
Button botonIniciar;
...
void setup() {
  ...
  fondo9 = loadImage("fondo9.jpg");
  fondo10 = loadImage("fondo10.jpg");
  fondoCreditos = loadImage("fondo_creditos.jpg"); // Carga el nuevo fondo para la pantalla de créditos
...
void draw() {
  ...
  if (pantallaActual == 1) {
    ...
    image(fondoCreditos, 0, 0, width, height); // Muestra el fondo de la pantalla de créditos
    textAlign(CENTER);
    fill(255);
